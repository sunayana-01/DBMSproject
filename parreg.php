...
<head>
  ...
  <title>Parent Sign Up</title><title>Admin Dashboard</title><link rel="icon" href="../img/favicon2.png">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../"><b>SMS Parent</b>Sign Up</a><br>
  ...
  <div class="login-box-body">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input name="contact" type="tel" class="form-control" placeholder="Phone-number">
      ...
      <div class="form-group has-feedback">
        ...
        <span class="glyphicon glyphicon-skill form-control-feedback"></span>
      </div>
      <div class="row">
    ...
    if (isset($_POST['submit'])) {
      ...
      if ($pid != '' && $email != '' && $fname != '') {
        ...
        $sql = "INSERT INTO parent (pid, fname, lname, contact, job, address, gender, email) VALUES ('$pid', '$fname', '$lname', '$phone', '$job', '$addr', '$gen', '$email')";
