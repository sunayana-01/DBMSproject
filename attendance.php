          ...
          <div class="box box-primary">
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <label>Attendence_id</label>

                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-id"></i>
                  </div>
                  <input type="text" name='aid' class="form-control pull-right" placeholder="Enter Attendence id">
                </div>
                <!-- /.input group -->
              ...
              if (isset($_POST['submit'])) {
               ...
               $date = date_format(new DateTime($_POST['date']),'Y-m-d');
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO attendance (`date`,aid) VALUES ('".$date."', '".$id."')";
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $sql = "SELECT attendance.aid,attendance.date FROM attendance";
                  $result = $conn->query($sql);

                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> " . $row["aid"]. " </td><td> "  . $row["date"]. "</td> 
                      <td><a href='attendancelist.php?aid=". $row["aid"] ."&date=". $row["date"]."'><small class='label  bg-green'>View Report</small></a></td></tr>";
                       }
                                  }
