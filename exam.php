              ...
              if (isset($_POST['submit'])) {
               ...
               // $day = $_POST['day'];
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO exam(subject,teacher,`date`,stime,etime) VALUES ('".$subject."', '".$teacher."','".$date."','".$stime."','".$etime."')";
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> " . $row["id"]. " </td><td> " . $row["subject"]." </td><td> " . $row["teacher"] . $row["date"]. "</td><td>" . $row["stime"]. "</td><td>" . $row["etime"]. "</td></tr>";
                       }
                                  }
