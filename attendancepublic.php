...
if (!isset($_SESSION['user'])||$_SESSION['role']!='Student'||$_SESSION['role']!='Parent') {
  # code...
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                  ...
                  <input name="aid" type="text" class="form-control" id="exampleInputPassword1" disabled="disabled" value=<?php echo "'".$_GET['aid']."'"; ?>>
                </div>

                  <div class="form-group">
                  <label for="exampleInputPassword1">Date</label>
                  <input name="date" type="date" class="form-control" id="exampleInputPassword1" disabled="disabled" value=<?php echo "'".$_GET['date']."'"; ?>>
                </div>
...
<div class="box-footer">
            ...
            echo ' <a  href="attendancelist.php?view='.$_GET['aid'].'&aid='.$_GET['aid'].'&date='.$_GET['date'].'"  class="btn btn-primary">View Attendance</a>';
              
                                  }else{echo '<a href="attendancelist.php?mark='.$_GET['aid'].'&aid='.$_GET['aid'].'&date='.$_GET['date'].'  "class="btn btn-primary">Mark Attendance</a>';}
