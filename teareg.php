...
<head>
  ...
  <title>Teacher Sign Up</title><title>Admin Dashboard</title><link rel="icon" href="../img/favicon2.png">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../"><b>SMS Teacher</b>Sign Up</a><br>
  ...
  <div class="login-box-body">
    ...
    if (isset($_POST['submit'])) {
      ...
      if ($tid != '' && $email != '' && $fname != '') {
        ...
        $sql = "INSERT INTO teacher (tid, fname, lname, address, contact, bday, gender, email) VALUES ('$tid', '$fname', '$lname', '$addr', '$phone', '$dob', '$gen', '$email')";
