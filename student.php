...
<?php
 ...
 $sid =$fname =$lname = $dob = $gender = $address = $parent=" ";
              ...
              if (isset($_POST['submit'])) {
                ...
                $parent = $_POST['parent'];}
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO student (sid,fname,lname,bday,address,gender,parent,email) VALUES ('".$sid."', '".$fname."', '".$lname."','".$dob."','".$address."','".$gender."','".$parent."','".$email."')";
              ...
              if (isset($_POST['submit'])) {
                ...
                $parent = $_POST['parent'];
                  ...
                  try {
                    ...
                    $sql = "UPDATE student set fname='".$fname."',lname='".$lname."',bday='".$dob."',address='".$address."',gender='".$gender."',parent=".$parent.",email='".$email."' where sid='".$sid."'";
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> " . $row["sid"]. " </td><td> " . $row["fname"]." ". $row["lname"]. " </td><td> " . $row["bday"]. "</td><td>" . $row["gender"]. "</td><td>" . $row["address"]. "</td><td>" . $row["parent"]. "</td><td><a href='student.php?update=". $row["sid"]."'><small class='label  bg-orange'>Update</small></a></td></tr>";
                       }
                                  }
